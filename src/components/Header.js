...
const Header = () => {
  return (
    <header className= 'fixed mx-[120px] border-t-green-900 border-t-12 p-3 rounded-b-3xl bg-green-100  text-md  flex flex-wrap my-10 w-4/5 border border-black justify-between'>
