...
const Header = () => {
  return (
    <header className= 'shadow-2xl drop-shadow-2xl fixed mx-[30px] border-t-green-900 border-t-12 p-3 rounded-b-3xl bg-green-50  text-md  flex flex-wrap my-6 w-[95%] border border-black justify-between'>
